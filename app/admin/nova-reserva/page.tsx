...
export default function AdminNovaReservaPage(){
  ...
  async function submit(e:FormEvent){
    ...
    setCustomerId('');setVehicleId('');setPickupAt('');setReturnAt('');setNotes('');setStatus('confirmed');setSuccessOpen(true)
  }
