...
export default function Home(){
  ...
  return <main className="container"><section className="hero"><h1>AGENDA-GO</h1><p>Locação de veículos com reservas, disponibilidade e gestão centralizada.</p></section><section className="grid"><div className="card"><h3>Veículos</h3><div className="value">{stats.vehicles}</div><p>Disponíveis no catálogo</p></div><div className="card"><h3>Reservas</h3><div className="value">{stats.reservations}</div><p>{logged?'Suas reservas':'Entre para visualizar'}</p></div><div className="card"><h3>Confirmadas</h3><div className="value">{stats.confirmed}</div><p>Confirmadas, ativas ou concluídas</p></div><div className="card"><h3>Concluídas</h3><div className="value">R$ {stats.revenue.toFixed(2)}</div><p>Valor das suas locações concluídas</p></div></section><section className="section card"><h2>Reservas de veículos</h2><p>Consulte a frota, escolha as datas e faça sua reserva.</p><div className="actions"><a className="btn" href="/reservas">Fazer reserva</a><a className="btn secondary" href="/veiculos">Ver veículos</a>{!logged&&<a className="btn secondary" href="/login">Entrar</a>}</div></section></main>
}