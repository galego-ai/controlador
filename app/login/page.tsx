...
function LoginContent(){
  ...
  async function submit(e:FormEvent){
    ...
    if((role==='admin'||role==='manager')&&safeNext==='/admin'){window.location.href='/admin';return}
...
export default function LoginPage(){
  return <Suspense fallback={<main className="container"><div className="card">Carregando login...</div></main>}><LoginContent/></Suspense>
}
